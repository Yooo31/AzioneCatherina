...
export async function PUT(req: Request) {
  try {
    ...
    return NextResponse.json({ error: "Erreur lors de la modification du commentaire" }, { status: 400 });
  }
}
...
export async function DELETE(req: Request) {
  try {
    ...
    return NextResponse.json({ error: "Erreur lors de la suppression du commentaire" }, { status: 400 });
  }
}
